...
[TestClass]
public class SpanReaderCommandTest : BaseCommandTest
{
    ...
    {
        bool result = CommandSpanReader.TryParseCommand(input, out lineNumber, out ReadOnlySpan<char> commandSpan, out ReadOnlySpan<char> parametersSpan, out ReadOnlySpan<char> commentSpan);
